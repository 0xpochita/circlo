...
import { type CircleInfo, type CreateCircleParams, type CreateCircleResult } from "./circles.js";
import { getGoal, type CreateGoalParams, type CreateGoalResult } from "./goals.js";
import { type StakeParams, type StakeResult } from "./stakes.js";
...
export type CircloClient = {
    ...
    getTally(goalId: bigint): Promise<{
        counts: readonly bigint[];
        total: bigint;
    }>;
};
export declare function createCircloClient(config?: CircloClientConfig): CircloClient;
