    ...
    <div className="mx-auto flex min-h-dvh w-full max-w-md flex-col bg-main-bg pb-safe">
      ...
      <PageTransition>
        <div className="px-4 pt-8 pb-4 flex flex-col items-center">
          ...
          {status === "invalid-link" && (
            <ErrorCard
              icon={<HiOutlineExclamationTriangle className="w-7 h-7 text-red-400" />}
          ...
          {status === "expired" && (
            <ErrorCard
              icon={<HiOutlineExclamationTriangle className="w-7 h-7 text-orange-400" />}
          ...
          {(status === "ready" || status === "joining" || status === "joined") && circle && (
            <motion.div
