...
export default function FeatureCards() {
  return (
    <div className="grid grid-cols-2 gap-3 px-4 py-2">
      <div className="flex flex-col gap-3 rounded-2xl bg-white p-4 cursor-pointer transition-all duration-200 active:scale-[0.97]">
      ...
      <Link
        href="/explore"
        className="flex flex-col gap-3 rounded-2xl bg-white p-4 cursor-pointer transition-all duration-200 active:scale-[0.97]"
      >
