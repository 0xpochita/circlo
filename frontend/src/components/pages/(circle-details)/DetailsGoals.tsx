    ...
    <div className="px-4 py-2">
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center rounded-2xl bg-white py-10 px-4">
          ...
          <p className="text-xs text-muted text-center">Create the first goal for this circle</p>
        </div>
      ) : (
            ...
            >
              ...
              >
                ...
                <div className="flex items-center gap-1 shrink-0">
                  ...
                  <span className="text-xs font-medium text-main-text">{formatTimeLeft(g.deadline)}</span>
                </div>
              </Link>
            </motion.div>
          ))}
