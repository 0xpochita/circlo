...
import { HiXMark, HiOutlineDocumentDuplicate, HiCheck, HiOutlineLink } from "react-icons/hi2";
        ...
        <>
          ...
          >
            <div className="flex items-start justify-between px-6 pt-6 pb-4 shrink-0">
              <div>
                <h2 className="text-xl font-bold text-main-text">Share Circle</h2>
                <p className="mt-1 text-sm text-muted">Invite friends to join {circleName}</p>
              </div>
              <button
                type="button"
                onClick={onClose}
            ...
            <div className="flex-1 overflow-y-auto px-6 pb-8">
              <div className="flex flex-col items-center mb-5">
                <EmojiAvatar avatar={toAvatar(avatarEmoji, avatarColor)} size={64} shape="square" />
                <p className="mt-2 text-base font-semibold text-main-text">{circleName}</p>
              </div>
              ...
              {inviteCode && (
                <div className="mb-4 rounded-2xl bg-gray-50 p-4">
                  ...
                  <div className="flex items-center justify-between">
                    <p className="text-lg font-bold text-main-text tracking-wider">{inviteCode}</p>
                    <button
                      type="button"
